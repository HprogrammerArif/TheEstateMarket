const Footer = () => {
  return (
    <footer className="px-4 divide-y mt-10 bg-gray-200 dark:text-gray-800">
      <div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
        <div className="lg:w-3/5">
          ...
          <div className="flex ml-3 flex-col justify-center items-center lg:items-start">
            ...
            <div className="flex justify-start mb-0 space-x-3">
              <a
                rel="noopener noreferrer"
                href="#"
                title="Facebook"
        ...
        <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-3">
          ...
          <div className="space-y-3">
            <h3 className="uppercase font-bold dark:text-gray-900">Products</h3>
            <ul className="space-y-1">
              <li>
                <a rel="noopener noreferrer" href="#">
                  Take the toure
      ...
      <div className="py-6 font-bold text-sm text-center dark:text-gray-600">
        © TheEstateMarket Co. All rights reserved.
      </div>
    </footer>
  );
};
