    ...
    <header className="p-4  text-black-100 sticky z-10">
      <div className="container flex justify-between h-16 mx-auto">
        ...
        >
          ...
          <img className="w-16" src="https://i.ibb.co/94tY23G/Screenshot-2024-04-13-203604.png" alt="" />
          <span className="font-black text-xl text-violet-600 mt-1">TheEstate <br />Market</span>
          </div>
        </a>
